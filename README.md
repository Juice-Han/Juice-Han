...
- 멋쟁이 사자처럼 12기 백엔드 활동 (3월 ~ 12월)

### 2025년

- 인천대학교 졸업 작품 (1월 ~ 5월)
  - 생성형 AI를 이용한 메일 자동 교정 시스템 개발 : 백엔드 개발
 
- 테이브 16기 (9월 ~ 26년 1월)
  - 리액트 심화 스터디 기획 및 운영
  - 부모-자녀 페어링 기반 경제 키워드 교육 서비스 : 팀장 및 프론트엔드 개발 | 우수상, 인기상 수상

### 2026년

- Kt cloud tech up 2기 (3월 ~ )
  - STAR-ART(아이들을 위한 3D 가상 미술 전시회) : 팀장 및 프론트엔드 개발
...
주제: 아이들을 위한 3D 가상 미술 전시회

역할: 팀장, 프론트엔드

Github Repo: https://github.com/star-art-for-children
